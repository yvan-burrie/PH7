...
static int PH7_builtin_strrpos(ph7_context* pCtx, int nArg, ph7_value** apArg)
{
    ...
    if (nLen > 0 && nPatLen > 0)
    {
        ...
        for (;;)
        {
            ...
            rc = xPatternMatch((const void*)zPtr, (sxu32)(zEnd - zPtr), (const void*)zPattern, (sxu32)nPatLen,
                               &nOfft);
            if (rc == SXRET_OK)
            {
...
static int PH7_builtin_vprintf(ph7_context* pCtx, int nArg, ph7_value** apArg)
{
    ...
    /* Format the string */
    PH7_InputFormat(printfConsumer, pCtx, zFormat, nLen, n, (ph7_value**)SySetBasePtr(&sArg), (void*)&nCounter,
                    TRUE);
    /* Return the length of the outputted string */
    ph7_result_int64(pCtx, nCounter);
 ...
 */
PH7_PRIVATE sxi32
PH7_StripTagsFromString(ph7_context* pCtx, const char* zIn, int nByte, const char* zTaglist, int nTaglen)
{
...
static int PH7_builtin_str_replace(ph7_context* pCtx, int nArg, ph7_value** apArg)
{
    ...
    while (SXRET_OK == SySetGetNextEntry(&sSearch, (void**)&pSearch))
    {
        ...
        for (;;)
        {
            ...
            rc = xMatch(SyBlobDataAt(&sWorker, nCount), SyBlobLength(&sWorker) - nCount,
